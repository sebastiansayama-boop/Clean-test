...
class ProviderTimeoutAfterEffect(Exception):
    pass
...
class MockPaymentProvider:
    def __init__(self):
        self.payments = {
            "1001": Payment("pay_1001", "1001", 45.0, "USD"),
            "1002": Payment("pay_1002", "1002", 800.0, "USD"),
        }
        self.refunds = {}
        self.refund_calls = 0
    ...
    def refund(self, payment_id, amount, reason, idempotency_key):
        self.refund_calls += 1
        for r in self.refunds.values():
            if r["payment_id"] == payment_id and r["amount"] == amount:
                return r
        r = {
            "refund_id": f"re_{len(self.refunds) + 1:04d}",
